...
def xbrl_to_statement(ticker,data_path,log_time_folder,update_only=True):
    company_xbrl = CompanyStatementsXBRL(ticker,data_path,log_time_folder,update_only)
    company_json = CompanyStatementsJSON(ticker,data_path,log_time_folder,update_only)
    company_csv = CompanyStatementCSV(ticker,data_path,log_time_folder,update_only)
        #company_timeseries = CompanyStatementTimeseries(ticker,data_path,log_time_folder,update_only)
    company_timeseries = CompanyStatementTimeseries(ticker,data_path,log_time_folder,update_only)
...
for ticker in ticker_list: 
    ...
    start_time = time()
    xbrl_to_statement(ticker,data_path,log_time_folder,update_only)
    #company_timeseries = CompanyStatementTimeseries(ticker,data_path,log_time_folder,update_only)
    print(f"______{time()-start_time}______") 
  



print(random_ticker_list(10))
